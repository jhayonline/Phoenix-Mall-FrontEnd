...
import { UserProfile } from '@/lib/api/follows';
...
const UserProfile: React.FC = () => {
  ...
  const UserAvatar = ({ user, size = 10 }: { user: any; size?: number }) => {
    const url = resolveImageUrl(user.avatar_url);
    const sizeClass = `w-${size} h-${size}`;
    return (
      <div className={`${sizeClass} rounded-full overflow-hidden bg-gradient-to-r from-red-500 to-red-600 flex items-center justify-center flex-shrink-0`}>
        {url ? (
          <img
            src={url}
            alt={user.name}
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-6 mt-6 pt-4 border-t border-gray-100">
                  ...
                  <button
                    onClick={() => { setActiveTab('followers'); loadFollowers(profile.id); }}
                  ...
                  <button
                    onClick={() => { setActiveTab('following'); loadFollowing(profile.id); }}
              ...
              {followers.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  {followers.map((follower) => (
                    ...
                    >
                      <UserAvatar user={follower} size={10} />
                      <div>
              ...
              {following.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  {following.map((followed) => (
                    ...
                    >
                      <UserAvatar user={followed} size={10} />
                      <div>
